  ...
  return (
    <div className="h-screen w-full flex justify-center items-center">
      <div className="flex flex-col justify-center items-center">
        <div className=" bg-[#0F1015] relative shadow-xl/50 transition duration-600 hover:bg-[#0079E5] flex group w-84 h-20 rounded-full">
          ...
          <p className=" absolute scale-0 group-hover:scale-100 duration-600 text-2xl top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[#C5C3C6]">
            Light
          </p>
          <div className="h-full relative w-20 transition flex justify-center items-center  duration-600 ease-in-out group-hover:translate-x-64 rounded-full bg-[#C5C3C6] group-hover:bg-[#FFD026]">
            <Moon
